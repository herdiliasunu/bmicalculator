...
function BmiScore({bmiInput,bmiState,changeWeight}) {
  return ( 
    <div className="text-center shadow rounded p-5">
      <div>Your BMI Score</div>
       <div className="row justify-content-md-center">
        <div className="p-3 my-2 alert fs-1 alert-primary col-sm-4">{bmiInput}</div>
      </div>
      <div className="fs-3 fw-bold text-primary">{bmiState}</div>
